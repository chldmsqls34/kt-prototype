          ...
          <div className="rounded-lg bg-white outline outline-1 -outline-offset-1 outline-gray-300">
            ...
            <div className="flex whitespace-nowrap border-b">
              <input
                ...
                {...register('title')}
              />
              {errors.title && <p className="text-[--main-red-color] text-xs p-5">{errors.title.message}</p>}
            </div>
            ...
            <textarea
              ...
              {...register('content')}
            />
            {errors.content && <p className="text-[--main-red-color] text-xs p-5">{errors.content.message}</p>}
          </div>
